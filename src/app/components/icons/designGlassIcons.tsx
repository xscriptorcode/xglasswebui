export function ColorPaletteIconGlass() {
  return (
    <div
    ...
    >
      ...
      >
        <path d="M19.8 15.5c-.8 1.7-2.6 2.5-4.4 2.2a3 3 0 0 0-3.3 4.1c.5 1.6-1.5 2.9-3.5 2.1C6.7 22.7 3 18.3 3 12.6 3 7.3 7.3 3 12.6 3c5.7 0 10.1 3.7 11.3 8.6.7 3-1.8 4.6-4.1 3.9Z" stroke="currentColor" />
...
export function ComponentIconGlass() {
  return (
    <div
      className="w-16 h-16 sm:w-20 sm:h-20 p-3 rounded-2xl backdrop-blur-md bg-white/10 border border-white/20 shadow-lg flex items-center justify-center transition hover:scale-105"
      title="Component"
...
export function TaskListIconGlass() {
  return (
    <div
      className="w-16 h-16 sm:w-20 sm:h-20 p-3 rounded-2xl backdrop-blur-md bg-white/10 border border-white/20 shadow-lg flex items-center justify-center transition hover:scale-105"
      title="Task List"
...
export function TrophyIconGlass() {
  return (
    <div
      className="w-16 h-16 sm:w-20 sm:h-20 p-3 rounded-2xl backdrop-blur-md bg-white/10 border border-white/20 shadow-lg flex items-center justify-center transition hover:scale-105"
...
export function TypographyIconGlass() {
  return (
    <div
      className="w-16 h-16 sm:w-20 sm:h-20 p-3 font-serif text-current text-3xl sm:text-4xl rounded-2xl backdrop-blur-md bg-white/10 border border-white/20 shadow-lg flex items-center justify-center transition hover:scale-105"
      title="Typography"
    >
      <span className="font-serif tracking-tight">Xt</span>
    </div>
  );
}


export function WorkHistoryIconGlass() {
  return (
    <div
      className="w-16 h-16 sm:w-20 sm:h-20 p-3 rounded-2xl backdrop-blur-md bg-white/10 border border-white/20 shadow-lg flex items-center justify-center transition hover:scale-105"
      title="Work History"
...
export function RulerIconGlass() {
  return (
    <div
      className="w-16 h-16 sm:w-20 sm:h-20 p-3 rounded-2xl backdrop-blur-md bg-white/10 border border-white/20 shadow-lg flex items-center justify-center transition hover:scale-105"
      title="Ruler"
